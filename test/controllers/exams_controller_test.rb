...
class ExamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exam" do
    assert_difference('Exam.count') do
      post exams_url, params: { exam: { cholesterol: @exam.cholesterol, date: @exam.date, glicose: @exam.glicose, triglycerides: @exam.triglycerides } }
    end
  ...
  test "should update exam" do
    patch exam_url(@exam), params: { exam: { cholesterol: @exam.cholesterol, date: @exam.date, glicose: @exam.glicose, triglycerides: @exam.triglycerides } }
